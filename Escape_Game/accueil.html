...
<!--/********* Inscription *********/-->
	...
	<div class ="global">
		...
		<div class="popup" id="inscription_popup">
			<h1>Inscription</h1>
			<form id="inscription_form" action="http://localhost/Escape_Game/php/app/inscription.php" method="POST">
				<div id="formulaire">
					<div class="champs">
...
<!--/********* Connexion *********/-->
		...
		<div class="popup" id="connexion_popup">
			<h1>Connexion</h1>
			<form id="connexion_form" action="http://localhost/Escape_Game/php/app/connexion.php" method="POST">
				<div id="formulaire">
					<div class="champs">
